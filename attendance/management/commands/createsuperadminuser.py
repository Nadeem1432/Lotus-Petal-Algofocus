...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        try:
            ...
            group = Group.objects.get_or_create(name='superadmin')  # group create or get

            ''' NOTE : Get all permissions '''
            all_permissions = Permission.objects.all()

            group = Group.objects.get(name='superadmin')  # group get for add user


            try:
                ''' TODO : add permissions to superadmin group'''
