...
class Substitution(models.Model):
    ...
    current_subject = models.ForeignKey(Subject, on_delete=models.CASCADE)

    current_teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE)

    substituted_subject = models.ForeignKey(Subject, on_delete=models.CASCADE)

    substituted_teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE)
